          ...
          <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <ul class="navbar-nav mr-auto">
                      ...
                      <li class="nav-item">
                      <a class="app-menu__item" href=""><i class="app-menu__icon fas fa-list-alt"></i><span class="app-menu__label">Quienes somos</span></a>
                      </li>
              <li class="nav-item">
              <a class="app-menu__item" href=""><i class="app-menu__icon fas fa-list-alt"></i><span class="app-menu__label">Precios</span></a>
                      </li>
